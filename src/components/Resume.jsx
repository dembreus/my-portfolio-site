      ...
      <Grid className="resume-grid">
        <Cell col={4} className="resume-left-col">
          <div style={{ textAlign: "center" }}>
            <img src={Photo} alt="avatar" className="resume-img" />
          </div>
          <h2>Dillon Embreus</h2>
          <h4 style={{ color: "#aaa" }}>Programmer</h4>
          <hr style={{ width: "50%" }} />
          <p>
            Just Recently graduated from Helio Training Coding Bootcamp.
            Received my Certificate of Proficiency for the fundamentals of
            javaScript and Creating Full-Stack applications.
          </p>
          <hr style={{ width: "50%" }} />
          <h5>Address</h5>
        ...
        <Cell col={8} className="resume-right-col">
          ...
          <Education
            ...
            endYear={"Present"}
            schoolName={
              "Salt Lake City, UT, Salt Lake Community College, Computer Engineering"
            }
            schoolDescription={
          ...
          <Education
            ...
            endYear={"August 2018"}
            schoolName={
              " Salt Lake City, UT, Helio Training Coding Bootcamp, Full Stack Web Development "
            }
            schoolDescription={
          ...
          <Experience
            ...
            jobDescription={
              "Bartend a high-volume bar. Providing quality drinks, ensuring customer\n" +
          ...
          <Experience
            ...
            jobDescription={
              "Responsibilities ranged from cleaning, running food and drinks, to taking\n" +
          ...
          <Skills skill={"CSS"} progress={30} />

          <h4>Libraries</h4>
          <Skills skill={"React"} progress={45} />
          <Skills skill={"Bootstrap"} progress={35} />
          <Skills skill={"Skeleton"} progress={10} />
          <Skills skill={"React MDL"} progress={35} />
          <h4>RESTful Services</h4>
          <Skills skill={"Micro"} progress={20} />
          <Skills skill={"Prisma"} progress={20} />
          <Skills skill={"GraphQL"} progress={35} />
          <h4>IDE / Text Editors</h4>
          <Skills skill={"Webstorm"} progress={60} />
          <Skills skill={"Visual Studio"} progress={35} />
          <h4>Git Services</h4>
          <Skills skill={"GitHub"} progress={70} />
          <Skills skill={"GitLab"} progress={25} />
          <Skills skill={"GitKraken"} progress={60} />

          <h4>Data Bases</h4>
          <Skills skill={"MongoDB"} progress={20} />
          <h4>etc.</h4>
          <Skills skill={"GIT"} progress={35} />
          <Skills skill={"Node.js"} progress={35} />
        </Cell>
      </Grid>
    </Fragment>
  );
